This is a fork is for use in case the GDB Python Api uses Cython instead of Python.
If you get problems with the code it means you need to use the original.
for more info:
